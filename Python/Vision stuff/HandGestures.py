...
hand_cascade = cv2.CascadeClassifier('C:\\Users\\sesch\\Downloads\\Hand_Recognition-master\\Hand_haar_cascade.xml')
...
while 1:
	...
	for (x,y,w,h) in hand: # MARKING THE DETECTED ROI
		cv2.rectangle(img,(x-10,y-10),(x+w+20,y+h+20), (122,122,0), 2)
		cv2.rectangle(mask, (x-10,y-10),(x+w+20,y+h+20),255,-1)
	...
	if len(contours) > 0:
		...
		if count_defects == 1:
			cv2.putText(img,"THIS IS 2", fingerColors, cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
		elif count_defects == 2:
			cv2.putText(img, "THIS IS 3", fingerColors, cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
		elif count_defects == 3:
			cv2.putText(img,"This is 4", fingerColors, cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
		elif count_defects == 4:
			cv2.putText(img,"THIS IS 5", fingerColors, cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
